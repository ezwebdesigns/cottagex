  ...
  return (
    <div className="animate-in fade-in duration-300 max-w-5xl mx-auto px-4 py-12">
      <div className="text-center max-w-2xl mx-auto mb-12">
        <span className="text-[#0f51ec] font-bold text-xs uppercase bg-blue-50 px-3 py-1.5 rounded-full tracking-wider font-mono">{t('badge')}</span>
        <h1 className="text-3xl md:text-5xl font-bold text-[#191e3b] mt-4 mb-3">{t('title')}</h1>
      ...
      <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-lg max-w-2xl mx-auto">
        <h3 className="text-xl font-bold text-[#191e3b] mb-6 flex items-center gap-2"><Send size={20} className="text-[#0f51ec]" /> {t('formTitle')}</h3>
        ...
        <form onSubmit={handleContactSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wide mb-1">{t('nameLabel')}</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wide mb-1">{t('emailLabel')}</label>
            <input
              type="email"
              required
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wide mb-1">{t('messageLabel')}</label>
            <textarea
              rows={4}
              required
