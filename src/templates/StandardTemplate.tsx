    ...
    return (
      <div className="animate-in fade-in duration-300 max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white p-8 md:p-12 rounded-[2rem] border border-slate-100 shadow-sm">
          <div className="flex items-center gap-2 text-[#0f51ec] font-semibold text-sm mb-4">
          ...
          <div className="space-y-6 text-slate-600 leading-relaxed text-sm md:text-base">
            <h2 className="text-lg font-bold text-[#191e3b] mt-6">1. Platform Scope</h2>
            ...
            <h2 className="text-lg font-bold text-[#191e3b] mt-6">2. Affiliate Partnership Disclosure</h2>
    ...
    return (
      <div className="animate-in fade-in duration-300 max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <span className="text-[#0f51ec] font-bold text-xs uppercase bg-blue-50 px-3 py-1.5 rounded-full tracking-wider">Our Story</span>
          <h1 className="text-3xl md:text-5xl font-bold text-[#191e3b] mt-4 mb-3">{pageData.title || 'About Chalet Express'}</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h2 className="text-2xl font-bold text-[#191e3b] mb-4">Our Objective</h2>
            ...
            <ul className="space-y-3 font-medium text-slate-700">
              <li className="flex items-center gap-2"><CheckCircle className="text-[#0f51ec]" size={18} /> Premium Curated Local Selections</li>
              <li className="flex items-center gap-2"><CheckCircle className="text-[#0f51ec]" size={18} /> Direct Outgoing Affiliate Booking</li>
              <li className="flex items-center gap-2"><CheckCircle className="text-[#0f51ec]" size={18} /> Zero extra costs on your final invoice</li>
            </ul>
          </div>
