    ...
    <div className="max-w-4xl mx-auto p-6 md:p-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-3xl p-6 space-y-4">
          ...
          <p className="text-xs text-gray-400">Shortcode ex: <code className="text-[#1F51C6]">[ontario, rating, 6]</code></p>
        ...
        <div className="flex justify-end gap-3">
          <button type="button" onClick={() => router.push('/admin/destinations')} className="px-4 py-2 border border-gray-300 rounded-full text-sm text-gray-600 hover:bg-gray-50">Cancel</button>
          {slug && <button type="button" onClick={() => window.open(`/cottage-country/${slug}?preview=true`, '_blank')} className="px-4 py-2 border border-gray-300 rounded-full text-sm text-gray-600 hover:bg-gray-50 flex items-center gap-1.5"><Eye className="w-4 h-4" /> Preview</button>}
