...
export default function NewDestinationPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 md:p-10">
      <h1 className="text-2xl font-bold text-[#191e3b] mb-6">Create Destination</h1>
      <p className="text-sm text-slate-500 mb-6">This will be published at <code className="text-[#0f51ec]">/cottage-country/&lt;slug&gt;</code></p>
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-4">
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Name</label>
            <input value={title} onChange={e => setTitle(e.target.value)} className="w-full border border-gray-300 rounded-full px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#0f51ec]" placeholder="e.g. Algonquin Park" required />
          </div>
          <div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-4">
          ...
          <div className="grid grid-cols-5 gap-6">
            <div className="col-span-3 space-y-4">
              <div><label className="block text-sm font-medium text-slate-700 mb-1">Title</label><input value={locationData.cta?.title ?? ''} onChange={e => setLocationData({ ...locationData, cta: { ...locationData.cta, title: e.target.value } })} className="w-full border border-gray-300 rounded-full px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#0f51ec]" placeholder="Partner with us" /></div>
              <div><label className="block text-sm font-medium text-slate-700 mb-1">Description</label><textarea value={locationData.cta?.description ?? ''} onChange={e => setLocationData({ ...locationData, cta: { ...locationData.cta, description: e.target.value } })} className="w-full border border-gray-300 rounded-2xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#0f51ec] h-20" placeholder="Optional paragraph..." /></div>
              <div className="grid grid-cols-2 gap-4">
                <div><label className="block text-sm font-medium text-slate-700 mb-1">Button Text</label><input value={locationData.cta?.buttonText ?? ''} onChange={e => setLocationData({ ...locationData, cta: { ...locationData.cta, buttonText: e.target.value } })} className="w-full border border-gray-300 rounded-full px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#0f51ec]" placeholder="Contact us" /></div>
                <div><label className="block text-sm font-medium text-slate-700 mb-1">Button Link</label><input value={locationData.cta?.buttonLink ?? ''} onChange={e => setLocationData({ ...locationData, cta: { ...locationData.cta, buttonLink: e.target.value } })} className="w-full border border-gray-300 rounded-full px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#0f51ec]" placeholder="/en/contact" /></div>
              </div>
            </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-4">
          ...
          <div className="grid grid-cols-5 gap-6">
            <div className="col-span-3 space-y-4">
              <div><label className="block text-sm font-medium text-slate-700 mb-1">Title</label><input value={locationData.learnMore?.title ?? ''} onChange={e => setLocationData({ ...locationData, learnMore: { ...locationData.learnMore, title: e.target.value } })} className="w-full border border-gray-300 rounded-full px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#0f51ec]" placeholder="Learn more about..." /></div>
              <div><label className="block text-sm font-medium text-slate-700 mb-1">Description</label><textarea value={locationData.learnMore?.description ?? ''} onChange={e => setLocationData({ ...locationData, learnMore: { ...locationData.learnMore, description: e.target.value } })} className="w-full border border-gray-300 rounded-2xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#0f51ec] h-28" placeholder="Paragraph describing the region..." /></div>
            </div>
            <div className="col-span-2">
              <label className="block text-sm font-medium text-slate-700 mb-1">Image</label>
