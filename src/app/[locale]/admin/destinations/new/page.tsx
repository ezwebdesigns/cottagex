        ...
        <div className="bg-white border border-gray-200 rounded-3xl p-6 space-y-4">
          ...
          <div className="grid grid-cols-5 gap-6">
            <div className="col-span-3 space-y-4">
              <div><label className="block text-sm font-medium text-gray-700 mb-1">Title</label><input value={locationData.cta?.title ?? ''} onChange={e => setLocationData({ ...locationData, cta: { ...locationData.cta, title: e.target.value } })} className="w-full border border-gray-300 rounded-full px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#1F51C6]" placeholder="Partner with us" /></div>
              <div><label className="block text-sm font-medium text-gray-700 mb-1">Description</label><textarea value={locationData.cta?.description ?? ''} onChange={e => setLocationData({ ...locationData, cta: { ...locationData.cta, description: e.target.value } })} className="w-full border border-gray-300 rounded-2xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#1F51C6] h-20" placeholder="Optional paragraph..." /></div>
              <div className="grid grid-cols-2 gap-4">
                <div><label className="block text-sm font-medium text-gray-700 mb-1">Button Text</label><input value={locationData.cta?.buttonText ?? ''} onChange={e => setLocationData({ ...locationData, cta: { ...locationData.cta, buttonText: e.target.value } })} className="w-full border border-gray-300 rounded-full px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#1F51C6]" placeholder="Contact us" /></div>
                <div><label className="block text-sm font-medium text-gray-700 mb-1">Button Link</label><input value={locationData.cta?.buttonLink ?? ''} onChange={e => setLocationData({ ...locationData, cta: { ...locationData.cta, buttonLink: e.target.value } })} className="w-full border border-gray-300 rounded-full px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#1F51C6]" placeholder="/en/contact" /></div>
              </div>
            </div>
