        ...
        {template === 'location' && (
          <>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-4">
              ...
              <div><label className="block text-sm font-medium text-slate-700 mb-1">Title</label><input value={exploreTitle} onChange={e => setExploreTitle(e.target.value)} className="w-full border border-gray-300 rounded-full px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#0f51ec]" /></div>
              <div><label className="block text-sm font-medium text-slate-700 mb-1">Subtitle</label><input value={exploreSubtitle} onChange={e => setExploreSubtitle(e.target.value)} className="w-full border border-gray-300 rounded-full px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#0f51ec]" /></div>
              <div><label className="block text-sm font-medium text-slate-700 mb-1">Description</label><textarea value={exploreDescription} onChange={e => setExploreDescription(e.target.value)} className="w-full border border-gray-300 rounded-2xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#0f51ec] h-20" /></div>
              <div>
                ...
                <button type="button" onClick={() => setExploreItems([...exploreItems, { icon: 'Compass', title: '', description: '' }])} className="text-sm text-[#0f51ec] font-semibold hover:underline">+ Add Item</button>
              </div>
            </div>
