  ...
  return (
    <div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {[
          { label: 'Add Cottage', section: 'cottages', icon: Home },
          { label: 'Write Article', section: 'articles', icon: FileText },
          { label: 'View Messages', section: 'messages', icon: Mail }
        ].map((action) => (
          <button
            key={action.label}
