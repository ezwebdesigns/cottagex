// PropertyCard - paste from Base44
// Paste your Base44 code here.
import React from 'react';
import { Star, Heart, MapPin, ArrowUpRight } from 'lucide-react';
import { useLang } from '@/lib/LanguageContext';

export default function PropertyCard({ chalet, isFavorite, onToggleFavorite }) {
  const { t } = useLang();
  const badgeLabel = t.badges[chalet.badge] || chalet.badge;
