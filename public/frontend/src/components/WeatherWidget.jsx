// WeatherWidget - paste from Base44
...
export default function WeatherWidget() {
  ...
  const weather = weatherData.muskoka;
  const ConditionIcon = conditionIcons[weather.condition] || Sun;
  const conditionLabel = t.weather[weather.condition] || t.weather.partlyCloudy;
  const locationName = lang === 'fr' ? weather.locationFr : weather.location;
